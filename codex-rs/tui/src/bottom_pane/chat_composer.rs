...
impl ChatComposer {
    ...
    pub fn handle_paste(&mut self, pasted: String) -> bool {
        ...
        if char_count > LARGE_PASTE_CHAR_THRESHOLD {
            let placeholder = format!("[粘贴内容 {char_count} 字符]");
        ...
        match &self.active_popup {
            ...
            ActivePopup::None => {
                ...
                if let Some(token_usage_info) = &self.token_usage_info {
                    ...
                    hint.push("   ".into());
                    hint.push(
                        Span::from(format!("已用 {} tokens", token_usage.blended_total()))
...
mod tests {
    ...
    fn handle_paste_large_uses_placeholder_and_replaces_on_submit() {
        ...
        assert!(needs_redraw);
        let placeholder = format!("[粘贴内容 {} 字符]", large.chars().count());
    ...
    fn test_multiple_pastes_submission() {
        ...
        let states: Vec<_> = test_cases
            ...
            .map(|(content, is_large)| {
                ...
                if *is_large {
                    let placeholder = format!("[粘贴内容 {} 字符]", content.chars().count());
        ...
        assert_eq!(
            ...
            vec![
                ...
                (
                    format!("[粘贴内容 {} 字符] 和 ", test_cases[0].0.chars().count()),
                    1
                ),
                (
                    format!(
    ...
    fn test_partial_placeholder_deletion() {
        ...
        let placeholder = format!("[粘贴内容 {} 字符]", paste.chars().count());
